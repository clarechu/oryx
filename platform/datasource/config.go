...
type Config struct {
	...
	Key       string    `json:"key,omitempty" gorm:"column:c_key;index:idx_keys"`
	Field     string    `json:"field,omitempty" gorm:"column:c_field;index:idx_keys"`
	Value     string    `json:"value,omitempty" gorm:"column:c_value;type:text"`
